! function ( e, o ) {
  ...
  function a( e, o ) {
    var t = encodeURIComponent( window.location.protocol + "//" + window.location.host ),
      ...
      c = encodeURIComponent( d( e.extensions, "join", function ( e ) {
        return e.join( " " )
      } ) || "" ),
      u = Boolean( e.folderselect );
    o = Boolean( o );
    var p = Dropbox.baseUrl + "/chooser?origin=" + t + "&app_key=" + n + "&link_type=" + r + "&trigger=" + a + "&multiselect=" + l + "&extensions=" + c + "&folderselect=" + u + "&iframe=" + o;
  ...
  function u( e, o ) {
    ...
    var a = function ( o ) {
      ...
      } else "PENDING" === o.status || "DOWNLOADING" === o.status ? ( null != o.progress && "function" == typeof e.progress && e.progress( o.progress / 100 ), setTimeout( t, 1500 ) ) : "FAILED" === o.status && "function" == typeof e.error && e.error( o.error )
    };
  ...
  Object.defineProperty( o, "__esModule", {
  ...
  }, o.createChooserSession = l, o.createWidgetElement = c, o.handleJobId = u, o.handleMessageEvent = p, o.saverUrl = function ( e ) {
    ...
    o.last_navigation = {}, o.ieframe = null, o.currentChooserSession = null, n = 1, null == Dropbox.baseUrl && ( Dropbox.baseUrl = "https://www.dropbox.com" ), null == Dropbox.blockBaseUrl && ( Dropbox.blockBaseUrl = "https://dl-web.dropbox.com" ), Dropbox.addListener = function ( e, o, t ) {
      ...
      return t._handler = function ( e ) {
        e.source === t.contentWindow && e.origin === Dropbox.baseUrl && p( e, null, o.options )
  ...
  o.genericDropins = {
    ...
    var t = function ( e ) {
      var o, t, n;
      if ( "string" == typeof e[ 0 ] ) n = e.shift(), o = "string" == typeof e[ 0 ] ? e.shift() : a( n ), ( t = e.shift() || {} ).files = [ {
        url: n,
        filename: o
      } ];
      else {
    ...
    var s = function ( e, o, t ) {
        var r = function () {
            a.closed || ( a.close(), a.postMessage( JSON.stringify( {
              method: "close"
            } ), Dropbox.baseUrl ) ), Dropbox.removeListener( window, "message", i ), clearInterval( l )
          },
          i = function ( e ) {
      ...
      c = function ( e ) {
        if ( Dropbox.isBrowserSupported() ) {
          ...
          if ( e.iframe && !e.windowName ) {
            ...
            r.onClose = s( n.chooserUrl( r.options, r.options.iframe ), c, r.options ).onClose
          }
    ...
    p.styleSheet ? p.styleSheet.cssText = d : p.textContent = d, document.getElementsByTagName( "head" )[ 0 ].appendChild( p ), setTimeout( n.createIEFrame, 0 );
    var f = function () {
        ...
        return t.validateOptions = function () {
          ...
          if ( e( "initialViewType", "string" ), void 0 !== t.options.fields ) {
            ...
            for ( var l = 0, c = t.options.fields; l < c.length; l++ )
              if ( "string" != typeof c[ l ] ) throw new Error( "The fields option, if provided, must be an array of strings" )
          }
  ...
  o.initModule = function () {
    ...
    Dropbox.unmount = o, Dropbox.closeWindow = o, Dropbox.Mover = c.Mover, Dropbox.Previewer = u.Previewer, Dropbox.Chooser = s.Chooser, Dropbox.ZoomChooser = a.ZoomChooser, Dropbox.embed = function ( e, o ) {
      Dropbox.appKey && ( e = n( n( {}, e ), {
      ...
      for ( var e = document.getElementsByTagName( "a" ), o = e.length - 1; o >= 0; o-- ) {
        ...
        n.indexOf( "dropbox-saver" ) >= 0 ? function ( e ) {
          ...
          if ( o && e.parentElement ) {
            ...
            i.classList.add( "dropbox-embed-container" ), i.style.height = e.getAttribute( "data-height" ) || "100%", i.style.width = e.getAttribute( "data-width" ) || "100%", e.parentElement.replaceChild( i, e ), Dropbox.embed( {
              link: o,
              file: {
                zoom: t
              },
    ...
    s = function () {
        ...
        this.activeDropins = [], this.deleteActiveDropin = function ( o ) {
          ...
          try {
            var a = t.url(),
              ...
              c = n.PopupEnvironment.open( l, t.windowDimensions(), function () {
                s()
              } );
            ...
            e.activeDropins.push( p ), s = r( [ e.deleteActiveDropin( p ), s ] ), t.hasOnCloseDialogMessage() || t.setOnCloseDialogMessage( s ), p.cleanup = s
          } catch ( e ) {
            throw s(), e
          }
        }
      ...
      return e.prototype.mount = function ( e, t ) {
        ...
        try {
          ...
          var a = e.url();
          s.src = "" + o.TARGET_ORIGIN + a.pathname + a.search + "&iframe=true", s.scrolling = "no", t.appendChild( s ), n = r( [ function () {
            t.removeChild( s )
          }, n ] );
          var l = {
            dropin: e,
          ...
          this.activeDropins.push( l ), n = r( [ this.deleteActiveDropin( l ), n ] ), e.hasOnCloseDialogMessage() || e.setOnCloseDialogMessage( n ), l.cleanup = n
        } catch ( e ) {
          throw n(), e
        }
        ...
        var n = function ( n ) {
          if ( n.source === t() && n.origin === o.TARGET_ORIGIN ) {
            ...
            "object" == typeof r && "string" == typeof r.method && e.handleMessage( r )
          }
        };
  ...
  var s = function ( e ) {
    function o( o ) {
      ...
      return i.state = {
        ...
        folder_view: null === ( n = i.options.folder ) || void 0 === n ? void 0 : n.view,
        folder_headerSize: null === ( r = i.options.folder ) || void 0 === r ? void 0 : r.headerSize
      }, i
    }
  ...
  var s = function ( e ) {
    function o( t ) {
      ...
      }, n.onSuccess = n.options.onSuccess, n.onCancel = n.options.onCancel, n.onFolderSelected = n.options.onFolderSelected, n
    }
    return r( o, e ), o.validateOnSuccess = function ( e ) {
      ...
      return [ {
        ...
        value: this.options.showFoldersOnly ? String( this.options.showFoldersOnly ) : ""
      } ]
    }, o.prototype.urlPathname = function () {
